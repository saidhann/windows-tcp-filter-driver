...
static NTSTATUS InitializeNetworkBufferListStorage(NetworkBufferListStorage& storage,
    ...
    ULONG size)
{
    storage.ptr = ExAllocatePool2(POOL_FLAG_NON_PAGED | POOL_FLAG_UNINITIALIZED,
        size,
...
{
    auto netBufferStorage = reinterpret_cast<NetworkBufferListStorage*>(ExAllocatePool2(
...
{
    auto params = reinterpret_cast<SendParameters*>(ExAllocatePool2(
        POOL_FLAG_NON_PAGED | POOL_FLAG_UNINITIALIZED,
